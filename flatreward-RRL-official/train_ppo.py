...
if __name__ == '__main__':
    parser = argparse.ArgumentParser("Hyperparameters Setting for SAM-PPO-continuous")

    parser.add_argument("--config", type=str, default="configs/half_cheetah.yaml", help="Path to the config file")
    ...
    parser.add_argument("--convergence_threshold", type=float, default=4000,
